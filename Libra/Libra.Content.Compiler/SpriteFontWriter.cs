...
namespace Libra.Content.Compiler
{
    public sealed class SpriteFontWriter : ContentTypeWriter<SpriteFontContent>
    {
        ...
        static void WriteBitmap(ContentWriter writer, Bitmap bitmap, bool premultiplyAlpha)
        {
        ...
        static void WriteRgba32(ContentWriter writer, Bitmap bitmap)
        {
        ...
        static void WriteBgra4444(ContentWriter writer, Bitmap bitmap)
        {
        ...
        static void WriteCompressedMono(ContentWriter writer, Bitmap bitmap, bool premultiplyAlpha)
        {
            if ((bitmap.Width & 3) != 0 ||
                (bitmap.Height & 3) != 0)
            {
            ...
            using (var bitmapData = new BitmapUtils.PixelAccessor(bitmap, ImageLockMode.ReadOnly))
            {
                for (int y = 0; y < bitmap.Height; y += 4)
                {
                    ...
                    {
                        CompressBlock(writer, bitmapData, x, y, premultiplyAlpha);
                    }
                }
            }
        }
        ...
        static void CompressBlock(ContentWriter writer, BitmapUtils.PixelAccessor bitmapData, int blockX, int blockY, bool premultiplyAlpha)
        {
            long alphaBits = 0;
            int rgbBits = 0;
